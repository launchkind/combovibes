...
export default function AddToCartButton({ product }: { product: DBProduct }) {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* WhatsApp order */}
      <a
        href={`https://wa.me/919608217057?text=Hi! I want to order: ${encodeURIComponent(product.name)} (Qty: ${qty})`}
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center gap-2 w-full py-3 rounded-xl text-sm font-bold border-2 border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white transition-all"
      >
